...
from gnosis.eth.django.models import EthereumAddressFastBinaryField, Uint256Field
...
class Chain(models.Model):
    ...
    ens_registry_address = EthereumAddressFastBinaryField(null=True, blank=True)  # type: ignore[no-untyped-call]
    ...
    safe_singleton_address = EthereumAddressFastBinaryField(null=True, blank=True)  # type: ignore[no-untyped-call]
    safe_proxy_factory_address = EthereumAddressFastBinaryField(null=True, blank=True)  # type: ignore[no-untyped-call]
    multi_send_address = EthereumAddressFastBinaryField(null=True, blank=True)  # type: ignore[no-untyped-call]
    multi_send_call_only_address = EthereumAddressFastBinaryField(null=True, blank=True)  # type: ignore[no-untyped-call]
    fallback_handler_address = EthereumAddressFastBinaryField(null=True, blank=True)  # type: ignore[no-untyped-call]
    sign_message_lib_address = EthereumAddressFastBinaryField(null=True, blank=True)  # type: ignore[no-untyped-call]
    create_call_address = EthereumAddressFastBinaryField(null=True, blank=True)  # type: ignore[no-untyped-call]
    simulate_tx_accessor_address = EthereumAddressFastBinaryField(null=True, blank=True)  # type: ignore[no-untyped-call]
    safe_web_authn_signer_factory_address = EthereumAddressFastBinaryField(
